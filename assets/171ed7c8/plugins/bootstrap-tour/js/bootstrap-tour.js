    ...
    Tour = (function() {
        function Tour(options) {
            ...
            this._options = $.extend({
                ...
                debug: false, //开启调试
                backdrop: true, //开启背景遮罩
                backdropContainer: 'html', //背景元素
                backdropPadding: 0,
                redirect: false,
                orphan: false,
                animation: false,
                ...
                delay: false,
                basePath: "",
                template: "<div class='popover tour my-tour' style='width: 300px;'>" +
                    "<div class='arrow'></div>" +
                    "<h3 class='popover-title'></h3>" +
                    "<div class='popover-content' data-role='offset'></div>" +
                    "<div class='popover-navigation'>" +
                    "<button class='btn btn-default btn-sm text-left tour-btn'  data-role='prev'>" +
                    "上一步" +
                    "</button>" +
                    "<button class='btn btn-default btn-sm text-center tour-btn' data-role='next'>" +
                    "下一步" +
                    "</button>" +
                    "<span class='guide-page'></span>" +
                    "<button class='btn btn-default btn-sm text-right tour-btn' data-role='end'>结束引导</button>" +
                    "</div>" +
                    "</div>",
        ...
        Tour.prototype._template = function(step, i) {
             ...
             * */
            if (step.prev < 0) {
                $prev.addClass('hidden').prop('hidden', true).prop('tabindex', -1);
            }
            if (step.next < 0) {
                $next.addClass('hidden').prop('hidden', true).prop('tabindex', -1);
            }
            if (!step.duration) {
                $resume.remove();
            }
